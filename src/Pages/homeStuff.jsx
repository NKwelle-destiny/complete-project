...
function ImageWithText() {
  ...
  {/* Overlay */}
  <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-16">
    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-4">
      Personalized meal plans for your health
    </h2>
    <p className="text-sm sm:text-base md:text-lg text-white max-w-3xl">
      Craving something delicious? Mallah delivers fresh, flavorful meals from your favorite restaurants straight to your door fast and convenient. Whether it’s a hearty dinner, a light lunch, or a sweet treat, we bring you great food to enjoy anytime, anywhere.
    </p>
  </div>
</div>
